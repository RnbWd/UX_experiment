  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:"container", onClick:this.handleClick, onWheel:this.handleScroll} , 
        ...
        React.DOM.span( {className:value === "Circle" ? 'active' : 'passive'}, "Circle"),
        React.DOM.span( {className:value === "Vertical" ? 'active' : 'passive'}, "Vertical"),
        React.DOM.span( {className:value === "Mandala" ? 'active' : 'passive'}, "Mandala"),
        Progress( {side:value} ),
