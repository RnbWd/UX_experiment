...
var Center = React.createClass({displayName: 'Center',
  ...
  handleScroll: function(event) {
    ...
    TweenLite.to(eagle, 1, {rotation:"-360", force3D:true, useFrames:true})
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:"container", onWheel:this.handleScroll} , 
        React.DOM.h1( {style:hello}, React.DOM.input( {ref:"myInput", type:"text", value:value, onChange:this.handleInput} )),
