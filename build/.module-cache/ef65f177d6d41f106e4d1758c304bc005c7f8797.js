...
var Center = React.createClass({displayName: 'Center',
  ...
  update: function(event) {
    ...
    TweenLite.to(eagle, 1, {rotation:sum, force3D:true, useFrames:true, immediateRender:true});
    console.log("_" + sum);
    this.setState({value: sum});
  },
  handleScroll: function(event) {
    window.requestAnimationFrame(function(event) {this.update(event)}.bind(this));
