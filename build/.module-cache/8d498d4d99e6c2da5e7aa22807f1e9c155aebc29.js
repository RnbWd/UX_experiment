...
var Center = React.createClass({displayName: 'Center',
  ...
  update: function(timestamp) {
    ...
    tween = TweenMax.to(eagle, 50, {throwProps:{rotation:{end: function(n) {return Math.round(n/rotationSnap) * rotationSnap;}}}, transformOrigin:"50% 50% -400px", transformPerspective:500, rotation:sum, force3D:true, useFrames:true, immediateRender:true});
