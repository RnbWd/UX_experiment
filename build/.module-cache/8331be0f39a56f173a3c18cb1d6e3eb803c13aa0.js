...
var Center = React.createClass({displayName: 'Center',
  ...
  update: function(timestamp) {
    ...
    tween = TweenMax.to(eagle, 50, {onUpdate: function(style){console.log(style)}, onUpdateParams:[style], rotation:sum, force3D:true, useFrames:true, immediateRender:true});
    console.log("_" + sum);
