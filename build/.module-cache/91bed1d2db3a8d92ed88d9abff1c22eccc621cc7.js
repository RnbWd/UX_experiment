...
var Center = React.createClass({displayName: 'Center',
  ...
  update: function(timestamp) {
    ...
    tween = TweenMax.to(eagle, 50, {onUpdate: console.log(eagle), transformOrigin:"50% 50% -400px", transformPerspective:500, rotation:sum, force3D:true, useFrames:true, immediateRender:true});
    console.log("_" + sum);
