...
var Center = React.createClass({displayName: 'Center',
  ...
  update: function(timestamp) {
    ...
    var awesome = mori.hashMap({transformOrigin:"50% 50% -400px", transformPerspective:500, gouche:(sum), force3D:true, useFrames:true, immediateRender:true})
    tween = TweenMax.to(eagle, 50, {transformOrigin:"50% 50% -400px", transformPerspective:500, gouche:(sum), force3D:true, useFrames:true, immediateRender:true});
