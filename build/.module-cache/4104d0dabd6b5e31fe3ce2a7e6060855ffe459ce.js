...
var Center = React.createClass({displayName: 'Center',
  ...
  update: function(timestamp) {
    ...
    tween = TweenMax.to(eagle, 50, {transformOrigin:"50% 50% -400px", transformPerspective:500, rotation:(sum-sum%90), force3D:true, useFrames:true, immediateRender:true});
  ...
  render:function() {
    ...
    return(
      React.DOM.div( {style:style, className:"box"}, 
        React.DOM.button( {className:"blue"})
      )
      );
  }
});
